	...
	return (
		<div className="customer-stories">
			...
			<p className="customer-stories-description">
				Explore the positive influence we have had on our clients by
				delving into their testimonials. Our clients have firsthand
				experience of our service and the results we deliver, and they
				are enthusiastic about sharing their favorable experiences with
				you.
			</p>
			<div className="customer-testimonials-container">
				...
				<div className="customer-testimonial">
					<p>
						I rented a vintage car from Vintage Car Rental for my
						wedding and I couldn't be happier with their service.
						The car was in pristine condition, the staff was
						friendly and professional, and the entire process was
				...
				<div className="customer-testimonial">
					<p>
						I've rented from Vintage Car Rental several times now
						and I'm always impressed with the quality of their cars
						and their customer service. The team goes above and
				...
				<div className="customer-testimonial">
					<p>
						Vintage Car Rental is hands down the best car rental
						company I've ever used. The cars are beautiful and in
				...
				<div className="customer-testimonial">
					<p>
						Vintage Car Rental helped me surprise my dad on his
						birthday by renting a vintage car he had always dreamed
						of owning. The team was incredibly accommodating and
				...
				<div className="customer-testimonial">
					<p>
						I rented a vintage car from Vintage Car Rental for a
						photo shoot and I was blown away by the quality of the
						car and the professionalism of the team. They made sure
